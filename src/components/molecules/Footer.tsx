...
const Footer = (): JSX.Element => {
  ...
  return (
    <footer className='bg-[#22c55e] w-full py-5 text-white'>
      <div className='w-11/12 md:w-10/12 mx-auto space-y-12'>
        ...
        <section className='flex-[1] text-white_2 mx-5 py-3 w-4/12 sm:w-3/12 md:w-max space-y-4'>
          ...
          <h3>
            Address :{' '}
            <span className='capitalize text-xs sm:text-[13px] md:text-[12px]'>
